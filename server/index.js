...
// // tells express what folder to find the static files in (don't look in the server folder)
...
//     res.json(["meaty", "fantastic", "out of this world"])
// })

// app.get("/burrito", (req, res) => {
//     // telling it what res.json is, for our response question in the fetch call
//     res.json(["tasty", "delicious", "amazing"])
// })
